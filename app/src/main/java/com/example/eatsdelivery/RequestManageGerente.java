...
public class RequestManageGerente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_manage_gerente);
        ...
        lista = (LinearLayout) findViewById(R.id.list_request_gerente);
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent next = new Intent(getApplicationContext(), AcceptRequestGerente.class);
